...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  ...
  1 /* alarm alarm3 : stdAppmode */ ,
  1 /* alarm alarm4 : stdAppmode */ 
};
...
/* Alarm alarm3 identifier */
#define alarm3_id 3
CONST(AlarmType, AUTOMATIC) alarm3 = alarm3_id;

/* Alarm alarm4 identifier */
#define alarm4_id 4
CONST(AlarmType, AUTOMATIC) alarm4 = alarm4_id;
...
CONST(tpl_tick, OS_CONST) OSTICKSPERBASE_counter1 = 1;
CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE_counter1 = 65535;
CONST(tpl_tick, OS_CONST) OSMINCYCLE_counter1 = 1;
...
ISR(TIMER1_OVF_vect)
{
  tpl_avr_counter_tick(&counter1_counter_desc);
}
...
/*
 * Event structure of task Task2
 */
VAR(tpl_task_events, OS_VAR) Task2_task_evts = {
  /* event set  */ 0,
  /* event wait */ 0
};
...
#include "tpl_memmap.h"
tpl_stack_word Task3_stack_zone[64/sizeof(tpl_stack_word)];
...
#define Task3_STACK { Task3_stack_zone, 64 }
...
/*-----------------------------------------------------------------------------
 * Alarm alarm3 descriptor
 *
 * This alarm does a set of event Event1 to task Task2
 */
...
CONST(tpl_setevent_action, OS_CONST) alarm3_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) alarm3_static = {
  {
    /* pointer to counter           */  &counter1_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , alarm3_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&alarm3_action
};
...
VAR(tpl_time_obj, OS_VAR) alarm3_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&alarm3_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  40,
    /* date                         */  15,
...
/*-----------------------------------------------------------------------------
 * Alarm alarm4 descriptor
 *
 * This alarm does a set of event Event2 to task Task2
 */
...
CONST(tpl_setevent_action, OS_CONST) alarm4_action = {
  {
    /* action function  */    tpl_action_setevent
  },
  /* task id              */  Task2_id,
  /* event mask           */  Event2_mask
};
...
CONST(tpl_alarm_static, OS_CONST) alarm4_static = {
  {
    /* pointer to counter           */  &counter1_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , alarm4_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&alarm4_action
};
...
VAR(tpl_time_obj, OS_VAR) alarm4_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&alarm4_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  40,
    /* date                         */  35,
