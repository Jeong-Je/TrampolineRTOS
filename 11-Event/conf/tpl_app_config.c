...
#define TickPrint_id 1
CONST(TaskType, AUTOMATIC) TickPrint = TickPrint_id;

/* ISR ISRPin2 identifier */
#define ISRPin2_id 2
/* ISR ISRPin3 identifier */
#define ISRPin3_id 3
/*=============================================================================
...
/*
 * Event structure of task Task1
 */
VAR(tpl_task_events, OS_VAR) Task1_task_evts = {
  /* event set  */ 0,
  /* event wait */ 0
};
 ...
 */
/*-----------------------------------------------------------------------------
 * ISR ISRPin2 descriptor
 */
#define APP_ISR_ISRPin2_START_SEC_CODE
#include "tpl_memmap.h"
/*
 * ISR ISRPin2 function prototype
 */
FUNC(void, OS_APPL_CODE) ISRPin2_function(void);
#define APP_ISR_ISRPin2_STOP_SEC_CODE
#include "tpl_memmap.h"

/*-----------------------------------------------------------------------------
 * Target specific structures of isr ISRPin2
 */
 ...
 *
 */
#define APP_ISR_ISRPin2_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word ISRPin2_stack_zone[256/sizeof(tpl_stack_word)];
#define APP_ISR_ISRPin2_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define ISRPin2_STACK { ISRPin2_stack_zone, 256 }

/*
 * ISR ISRPin2 context
 */
avr_context ISRPin2_int_context;
#define ISRPin2_CONTEXT &ISRPin2_int_context
...
/*
 * Static descriptor of ISR ISRPin2
 */
CONST(tpl_proc_static, OS_CONST) ISRPin2_isr_stat_desc = {
  /* context                  */  ISRPin2_CONTEXT,
  /* stack                    */  ISRPin2_STACK,
  /* entry point (function)   */  ISRPin2_function,
  /* internal ressource       */  NULL,
  /* ISR id                   */  ISRPin2_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
CONST(tpl_isr_static, OS_CONST) ISRPin2_isr_helper = {
  /* helper */ NULL,
  /* next */   NULL,
  /* id */     ISRPin2_id
};
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of ISR ISRPin2
 */
VAR(tpl_proc, OS_VAR) ISRPin2_isr_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
/*-----------------------------------------------------------------------------
 * ISR ISRPin3 descriptor
 */
#define APP_ISR_ISRPin3_START_SEC_CODE
#include "tpl_memmap.h"
/*
 * ISR ISRPin3 function prototype
 */
FUNC(void, OS_APPL_CODE) ISRPin3_function(void);
#define APP_ISR_ISRPin3_STOP_SEC_CODE
#include "tpl_memmap.h"

/*-----------------------------------------------------------------------------
 * Target specific structures of isr ISRPin3
 */
 ...
 *
 */
#define APP_ISR_ISRPin3_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word ISRPin3_stack_zone[256/sizeof(tpl_stack_word)];
#define APP_ISR_ISRPin3_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define ISRPin3_STACK { ISRPin3_stack_zone, 256 }

/*
 * ISR ISRPin3 context
 */
avr_context ISRPin3_int_context;
#define ISRPin3_CONTEXT &ISRPin3_int_context
...
/*
 * Static descriptor of ISR ISRPin3
 */
CONST(tpl_proc_static, OS_CONST) ISRPin3_isr_stat_desc = {
  /* context                  */  ISRPin3_CONTEXT,
  /* stack                    */  ISRPin3_STACK,
  /* entry point (function)   */  ISRPin3_function,
  /* internal ressource       */  NULL,
  /* ISR id                   */  ISRPin3_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
CONST(tpl_isr_static, OS_CONST) ISRPin3_isr_helper = {
  /* helper */ NULL,
  /* next */   NULL,
  /* id */     ISRPin3_id
};
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of ISR ISRPin3
 */
VAR(tpl_proc, OS_VAR) ISRPin3_isr_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
FUNC(void, OS_CODE) PIN2_Handler(void)
{
  tpl_avr_ISR2_handler(ISRPin2_id);
}

FUNC(void, OS_CODE) PIN3_Handler(void)
{
  tpl_avr_ISR2_handler(ISRPin3_id);
}
...
tpl_stat_proc_table[TASK_COUNT+ISR_COUNT+1] = {
  ...
  &ISRPin2_isr_stat_desc,
  &ISRPin3_isr_stat_desc,
