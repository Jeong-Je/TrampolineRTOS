...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file conf.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=../../goil/templates/ conf.oil")
	sys.exit(1)
...
oilCompiler = "goil"
oilFlags = ["-t=avr/arduino/uno", "--templates=../../goil/templates/"]
