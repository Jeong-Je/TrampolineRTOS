...
/* Event Event2 */
#define Event2_mask 2
CONST(EventMaskType, AUTOMATIC) Event2 = Event2_mask;
...
/* Resource S2 */
#define S2_id 0
CONST(ResourceType, AUTOMATIC) S2 = S2_id;
...
#include "tpl_memmap.h"
/*-----------------------------------------------------------------------------
 * Resource descriptor of resource S2
 *
 * Tasks which use this resource :
 * TaskH
 * TaskL
 */
VAR(tpl_resource, OS_VAR) S2_rez_desc = {
...
#include "tpl_memmap.h"
tpl_stack_word TaskL_stack_zone[256/sizeof(tpl_stack_word)];
...
#define TaskL_STACK { TaskL_stack_zone, 256 }
...
#include "tpl_memmap.h"
tpl_stack_word TaskH_stack_zone[256/sizeof(tpl_stack_word)];
...
#define TaskH_STACK { TaskH_stack_zone, 256 }
...
#include "tpl_memmap.h"
tpl_stack_word TickPrint_stack_zone[256/sizeof(tpl_stack_word)];
...
#define TickPrint_STACK { TickPrint_stack_zone, 256 }
