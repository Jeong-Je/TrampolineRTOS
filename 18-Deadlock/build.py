...
includeDirs += ["-I","../../machines/avr/arduino/variants/standard"]
...
ldflags += "-Wl,-Map=counter.map".split()
preldflags += "-lm".split()
...
cSourceList.append(projfile.ProjectFile("bsw.cpp"))
cSourceList.append(projfile.ProjectFile("asw.c"))
cSourceList.append(projfile.ProjectFile("mutex.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary base.hex from base")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("base")
  postCommand.mCommand.append("base.hex")
...
postVariableMapping = dict(
  ...
  BOARD_PATH='../../machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing base on avr/arduino/uno\033[0m")
