 ...
 */
/*-----------------------------------------------------------------------------
 * Constants of the counter DefaultTimer
 */
extern CONST(tpl_tick, OS_CONST) OSTICKSPERBASE_DefaultTimer;
extern CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE_DefaultTimer;
extern CONST(tpl_tick, OS_CONST) OSMINCYCLE_DefaultTimer;
